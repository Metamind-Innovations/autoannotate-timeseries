...
DEFAULT_CONFIG = {
    ...
    "interactive": {"n_representative_samples": 5, "show_plots": False, "auto_accept": False},
    "export": {"format": "csv", "include_metadata": True, "export_embeddings": False},
}


CACHE_DIR = Path.home() / ".cache" / "autoannotate-timeseries"
...
MIN_TS_PER_CLUSTER = 1
MAX_REPRESENTATIVE_SAMPLES = 20
DEFAULT_TS_MAX_LENGTH = 10000
MIN_TS_LENGTH = 10
